...
<div class="list-group" style="width:250px;margin-left:16px; float:left">
    ...
    <a href="/rejected" class="list-group-item active"><i class="fa fa-thumbs-o-down"></i> <span style="margin-left:5px;">My Rejected Requests</span></a>
...
<div class="container" style="padding-right:140px;padding-top:50px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            My Rejected Requests:<br><br>
                <?php
                use App\Rejected;
            
                $rejected_meetings = Rejected::where('Student_Name', Auth::user()->name)->get();
                ?>
                ...
                <tbody>
                <?php
                foreach($rejected_meetings as $reject){
                ?>
                <tr>
                <td><?php echo $reject -> Advisor_Name ?> </td>
                <td><?php echo $reject -> Date ?> </td>
                <td><?php echo $reject ->  Time?> </td>
                </tr>
